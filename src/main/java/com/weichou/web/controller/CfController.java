...
public class CfController extends BaseController {
    ...
    public ModelAndView cf(String code) {
        ...
        cf.setCfId(1);
        cf.setCfImg("/static/images/570350a217f3c1a_t9_640x480_thumb_245x184.jpg");
        cf.setCfJd("50%");
        ...
        cf1.setCfId(1);
        cf1.setCfImg("/static/images/570350a217f3c1a_t9_640x480_thumb_245x184.jpg");
        cf1.setCfJd("50%");
        ...
        cf2.setCfId(1);
        cf2.setCfImg("/static/images/570350a217f3c1a_t9_640x480_thumb_245x184.jpg");
        cf2.setCfJd("50%");
        ...
        cf3.setCfId(1);
        cf3.setCfImg("/static/images/570350a217f3c1a_t9_640x480_thumb_245x184.jpg");
        cf3.setCfJd("50%");
        ...
        cf4.setCfId(1);
        cf4.setCfImg("/static/images/570350a217f3c1a_t9_640x480_thumb_245x184.jpg");
        cf4.setCfJd("50%");
        ...
        cf5.setCfId(1);
        cf5.setCfImg("/static/images/570350a217f3c1a_t9_640x480_thumb_245x184.jpg");
        cf5.setCfJd("50%");
        ...
        cfList.add(cf);
        modelAndView.addObject("cfList", cfList);//热门
        modelAndView.addObject("newcfList", cfList);//最新
        modelAndView.addObject("xmzs", 2);//项目总数
        modelAndView.addObject("ljzcr", 2);//累计支持人
        modelAndView.addObject("ljzzje", 100000);//累计筹资金额
        return modelAndView;
    }
