...
function loginDialog() {
    var loginTpl = '<div class="titleWrap"><div class="title">登录<a class="shut-down-icon Js-pop-close"></a></div></div>\
                 ...
                 <div class="icon clearfix shell"><a class="wb" href="https://api.weibo.com/oauth2/authorize?client_id=1494625316&redirect_uri=http%3A%2F%2Fwww.zhongchou.com%2Fapi_callback.php%3Fc%3DSina%26response_type%3Dcode&response_type=code"></a><a class="qq" href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801393846&redirect_uri=http%3A%2F%2Fwww.zhongchou.com%2Fapi_callback.php%3Fc%3DTencent&response_type=code"></a></div>\
                 </div>\
                 </form>\
                 </div>';
            ...
            <form action="/User-ajax_register"  wx-validator-ajax  wx-validator name="registerForm" wx-validator-single-error="registerFormError" >\
                <div class="logleft">\
                    ...
                    <div class="numwrap shell clearfix hidden">\
                        <input disabled="disabled" id="v_code"  type="text" name="code" wx-validator-code-required="*请输入图形验证码" wx-validator-placeholder="验证码">\
                        <a href="javascript:;">\
                            <img id="m_code" style="width:78px;height:40px;" src="/verify.php" onclick="this.src=\'/verify.php?\' + Math.random();" class="get-verification-code" />\
                        </a>\
                    </div>\
                    ...
                    <div class="shell submitwrap clearfix">\
                        <span>\
                            <input class="xy" name="article" wx-validator-article-nocheck="请阅读协议并勾选同意" type="checkbox">\
                            <label>阅读并同意</label>\
                ...
                <div class="logright">\
                    ...
                    <div class="icon clearfix shell">\
                        <a class="wb" href="https://api.weibo.com/oauth2/authorize?client_id=1494625316&redirect_uri=http%3A%2F%2Fwww.zhongchou.com%2Fapi_callback.php%3Fc%3DSina%26response_type%3Dcode&response_type=code"></a>\
                        <a class="qq" href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801393846&redirect_uri=http%3A%2F%2Fwww.zhongchou.com%2Fapi_callback.php%3Fc%3DTencent&response_type=code"></a>\
                    </div>\
                </div>\
            </form>\
        </div>';
