...
<script type="text/javascript" src="./众筹网-中国最具影响力的创业众筹融资平台_files/352249857f6ed0f0bb25be546b087dec.js"></script>
<link rel="stylesheet" type="text/css"
                ...
                <div class="zhifuCBox">
                    ...
                    <div class="ui-view-container">
                        ...
                        <div data-ui-view="" class="animate-slide ng-scope"
                             style="min-height: 400px; position: relative; left: 0%;">
                            <div class="zffsCont ng-scope">
                                <div class="yfje_h3"><b style="width:200px;display:inline;float:left">应付金额</b><span
                                        class="ng-binding">1</span><span>¥</span></div>
                                <div class="zfMethodBox">
                                    <!-- ngIf: pay.payview.item_info.return_type!=3 -->
                                    <!-- ngIf: pay.payview.residue > 0 -->
                                </div>
                                <div class="zfPlatBox">
                                    <h2 class="title">请选择支付方式</h2>

                                    <div class="platform-box">
                                        <ul class="zfPlat_ul siteIlB_box" id="zfPlat_ul">
                                            <li class="cur">余额支付</li>
                                            <li class="last " ng-click="changeTab(2)">平台支付</li>
                                            <li class="last " ng-click="changeTab(3)">网银支付</li>
                                        </ul>
                                        <!-- end ngIf: !pay.isPlatformSelected -->
                                    </div>
                                    <div class="yfje_h3"><b style="width:200px;display:inline;float:left">账户余额</b><span
                                            class="ng-binding">2</span><span>¥</span></div>
                                </div>
                                <p class="zj_valP">支付<span><b>¥</b><span class="ng-binding">1</span></span></p>
                                <div class="zhifuTitle">
                                    <a target="_blank" href="${ctx }/cf/cfPaySuss.j" class="hoUdLink ng-binding">支付</a>
                                </div>
                            </div>
                            <!-- ngIf: qrcode_url -->
                            <div id="form-container" style="display:none" class="ng-scope"></div>
                        </div>
                    </div>
                </div>
