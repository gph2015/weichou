...
<div class="wdg-second-header">
    <div class="main-section">
        ...
        <ul class="site-nav">
            ...
            <li class="channel-item"><a href="/lend/loanList.action">众筹</a></li>
...
<div class="mainInnerBox">
    <div class="sousuoListBox clearfix">
        <div class="ssCardItem">
            <a href="http://www.zhongchou.com/deal-show/id-392464" class="siteCardItemImgA souSuo" target="_blank">
                <img src="${pageContext.request.contextPath}/static/images/5700b8f31d3771a_t9_640x480_thumb_245x184.jpg">
            </a>
            ...
            <div class="ssCardICBox siteCardICBox">
                <div class="ssCardICText">
                    <h3>
                        <a href="http://www.zhongchou.com/deal-show/id-392464" class="siteCardICH3"
                           title="【好茶不私享】春季头采日照绿茶，来自大山里的茶香氤氲，带您品味真正日照绿。" target="_blank">【好茶不私享】春季头采日照绿茶，来自大山里的茶香氤氲，带您品味真正日照绿。</a>
                    </h3>

                    <p class="siteCardIC_p souSuo">脚步离科技远一些，与自然便更亲近。我们是深山种茶人，这是我们的日照绿！陋室茗茶茶香里，推盏话人生，等您来。</p>
                </div>
                <div class="siteCardFBox">
                    ...
                    <div class="siteCardFLabelBox siteIlB_box">
                        ...
                        <a href="http://www.zhongchou.com/search/lid-64384" class="site_ALink siteIlB_item"
                           target="_blank">头采春茶</a>
                        <a href="http://www.zhongchou.com/search/lid-47227" class="site_ALink siteIlB_item"
                           target="_blank">日照绿茶</a>
                        <a href="http://www.zhongchou.com/search/lid-10957" class="site_ALink siteIlB_item"
                           target="_blank">茶</a>
                    </div>
            ...
            <div class="ssCardICBox siteCardICBox">
                ...
                <div class="siteCardFBox">
                    ...
                    <div class="siteCardFLabelBox siteIlB_box">
                        ...
                        <a href="http://www.zhongchou.com/search/lid-3" class="site_ALink siteIlB_item" target="_blank">通讯数码</a>
